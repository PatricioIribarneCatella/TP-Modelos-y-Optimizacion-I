...
import heuristica.utilitarios.ComparadorDistancias;

import java.util.LinkedList;
import java.util.List;

public class HeuristicaAmerica {

    private static int CANTIDAD_CIUDADES = 12;
    /*Se empieza el recorrido en Montevideo(Uruguay) que es la ciudad número 10 en la tabla*/
    private static int CIUDAD_COMIENZO = 10;
    private static double HORAS_POR_KILOMETRO = 0.006; /*1000 km son 6 horas*/
    private static int HORAS_DE_ESTADIA = 168;
    private static int HORAS_EXTRAS_DE_ESTADIA = 120;
    private static int BRASILIA = 2;
    private static int LIMA = 8;
    ...
    private int getCiudadAMinimaDistancia(double[] ciudadesAdyacentes, double tiempo) {
        ...
        ciudades.sort(new ComparadorDistancias());
        ...
        for (DistanciaPocision dp : ciudades) {
            ...
            if (!visitadas[dp.getPosicion()] && ciudadEsValida(dp.getPosicion(), tiempoAux)) {
